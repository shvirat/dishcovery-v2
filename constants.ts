...
export const MEAL_DB_API_BASE = 'https://www.themealdb.com/api/json/v1/1';
export const THEME_STORAGE_KEY = 'dishcovery-theme';
export const AUTH_STORAGE_KEY = 'dishcovery-auth';
